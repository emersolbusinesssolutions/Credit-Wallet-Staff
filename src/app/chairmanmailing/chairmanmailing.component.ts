...
@Component({
  selector: 'app-chairmanmailing',
  templateUrl: './chairmanmailing.component.html',
  styleUrls: ['./chairmanmailing.component.css']
})
export class ChairmanmailingComponent implements OnInit {
  ...
  send(){
    ...
    if (confirm('Are you sure you want to send this message?')) {
      ...
      this.service.bulkemail(param).subscribe(
        data => 
        {
          console.log(data)
