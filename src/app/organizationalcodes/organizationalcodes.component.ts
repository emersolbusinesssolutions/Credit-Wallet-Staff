...
@Component({
  selector: 'app-organizationalcodes',
  templateUrl: './organizationalcodes.component.html',
  styleUrls: ['./organizationalcodes.component.css']
})
export class OrganizationalcodesComponent implements OnInit {
  referralcodes;
  dataTable: any;
  code: any;
  description: any;
  ...
  ngOnInit() {
    ...
    this.service.organizationcodes().subscribe(
      data => 
      {
        this.loadingBar.complete();
        if(data["status"] == "success"){
          console.log(data)
          this.organizationcodes = data["organizationalcodes"]
