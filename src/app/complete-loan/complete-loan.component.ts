...
@Component({
  selector: 'app-complete-loan',
  templateUrl: './complete-loan.component.html',
  styleUrls: ['./complete-loan.component.css']
})
export class CompleteLoanComponent implements OnInit {
